...
(function(h) {
    ...
    function J(a, b, c, d) {
        cCD = "DataTables warning: " + (a ? "table id=" + a.sTableId +
            " - " : "") + c;
                    ...
                    for (i = t.length; j < i; j++) {
                        ...
                        if (o.nTable == this || o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) {
                            ...
                            if (g.bDestroy !== k ? g.bDestroy : l.bDestroy) {
                                ...
                                break
                            } else { JS(o, 0, "Cannot reinitialise DataTable", 3); return }
                        }
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Primeira", sLast: "Ultima", sNext: "Próxima", sPrevious: "Anterior" },
            sEmptyTable: "Não há informação",
            sInfo: "Exibindo _START_ a _END_ de _TOTAL_ Informações",
            sInfoEmpty: "Exibindo 0 de 0 de 0 Informações",
            sInfoFiltered: "(Pesquisado por _MAX_ total Informações)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: " _MENU_ ",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Nenhuma informação foi encontrada"
        },
