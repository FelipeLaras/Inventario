            ...
            <div id="formulario">
                ...
                <div class="control-group">
                    <label for="exampleFormControlTextarea1" class="control-label" style="margin-left: 7px;">
                        Observação:
                        <i class="icon-lithe icon-question-sign" title="Caso queira colocar alguma observação no termo de responsabilidade, basta informar aqui!"></i>
                    </label>
                        ...
                        <div class="row clearfix" style="width: 102%; margin-left: 0%;">
                            <div class="col-md-12 column" id="tab_logic_c">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php
                                        if (!empty($row_celular['patrimonio'])) {
                                            echo "<input type='text' name='patrimonio0' class='form-control input-md span3' value='" . $row_celular['patrimonio'] . "' />";
                                        } else {
                                            echo "
                                                <div class='autocomplete' style='width:200px;'>
                                                    <input type='text' id='myInput1' name='patrimonio0' class='form-control input-md span2'/>
                                                </div>
                                                ";
                                        }
                                        ?>
